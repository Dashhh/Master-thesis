...
\begin{figure}\label{fig1}
	...
	\begin{tikzpicture}
		...
		\newcommand\drawGadget
		{
			...
			\gadget{2*\edgeSize+3*\spacing}{s}
			\node at ($(g1center)!.5!(gscenter)$) {\ldots};	
		}
		...
		(v1) to (fn1);
	\end{tikzpicture}
	\caption{Construction of the composed instance $(G,F)$}
\end{figure}
